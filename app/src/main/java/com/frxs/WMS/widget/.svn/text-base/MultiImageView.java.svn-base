...
/**
 * Created by Chentie on 2018/3/9.
 */
...
//            }
    ...
    private ImageView createImageView(final int position, final boolean isMultiImage) {
        ...
        ImageLoader.loadImage(getContext(), url, imageView, R.mipmap.showcase_product_default, R.mipmap.showcase_product_default);
    ...
    class ColorFilterImageView extends ImageView implements OnTouchListener {
